...
de obtener los nodos y elementos finitos que pertenecen al borde empotrado de la
figura dada.

Al final del programa se exportan estos datos en un archivo de Excel del que se
podrán obtener los valores para ser leídos posteriormente.
...
# %% Se determinan qué curvas y puntos están contenidos en el borde empotrado:

puntos_ex = [1, 6, 4, 2, 7, 3]  # Puntos físicos en el borde empotrado
bordes_ex = [3, 4, 8, 9]   # Bordes físicos en el borde empotrado
...
df.to_excel('./malla/apoyo_empotrado.xlsx', sheet_name='empotramiento',
            index=False)
